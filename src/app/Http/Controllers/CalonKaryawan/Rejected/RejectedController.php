...
namespace App\Http\Controllers\CalonKaryawan\Rejected;
...
class RejectedController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return view('pages.calon-karyawan.rejected.index', compact('calonKaryawans'));
    ...
    public function show($id)
    {
        try {
            ...
            return view('pages.calon-karyawan.rejected.show', compact('calonKaryawan'));
