...
namespace App\Http\Controllers\CalonKaryawan\Offering;
...
class OfferingController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return view('pages.calon-karyawan.offering.index', compact('calonKaryawans'));

        } catch (\Throwable $e) {
            Log::error('[OfferingController@index] ' . $e->getMessage(), ['trace' => $e->getTraceAsString()]);
    ...
    public function show($id)
    {
        try {
            ...
            return view('pages.calon-karyawan.offering.show', compact('calonKaryawan'));

        } catch (\Throwable $e) {
            Log::error('[OfferingController@show] ' . $e->getMessage(), ['trace' => $e->getTraceAsString()]);
    ...
    public function destroy($id)
    {
        try {
            ...
            Log::error('[OfferingController@destroy] ' . $e->getMessage(), ['trace' => $e->getTraceAsString()]);
