...
@section('subtitle', 'Shortlist Admin')
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.calon-karyawan.shortlist-admin.index') }}" class="btn btn-light btn-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex gap-2">
                            <button type="button"
                                    ...
                                    data-url="{{ route('admin.calon-karyawan.shortlist-admin.destroy', $calonKaryawan->id) }}"
