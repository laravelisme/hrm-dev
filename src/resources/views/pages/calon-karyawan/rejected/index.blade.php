...
@section('title', 'Calon Karyawan - Rejected')
                ...
                <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-2">
                    <div>
                        ...
                        <p class="text-muted mb-0">
                            ...
                            <span class="ms-2 badge bg-light-danger text-dark">REJECTED</span>
                        </p>
                    </div>
            ...
            <div class="card-body">
                @if($calonKaryawans->count() === 0)
                    <div class="alert alert-light-danger mb-0">
                        ...
                        Tidak ada calon karyawan (REJECTED).
                    </div>
                @else
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a class="dropdown-item"
                                                       href="{{ route('admin.calon-karyawan.rejected.show', $ck->id) }}">
                                                ...
                                                <li>
                                                    <button type="button"
                                                        ...
                                                        <i class="bi bi-arrow-return-left me-2"></i> Kembalikan ke Shortlist Admin
                                                    </button>
                                                </li>
                                                ...
                                                <li>
                                                    <button type="button"
                                                            ...
                                                            data-url="{{ route('admin.calon-karyawan.rejected.destroy', $ck->id) }}"
                                                            data-name="{{ $ck->nama_lengkap }}"
                                                            data-nik="{{ $ck->nik }}">
...
Terima kasih sudah meluangkan waktu untuk mengikuti proses rekrutmen bersama kami.

Setelah melalui proses seleksi, kami mohon maaf untuk menyampaikan bahwa Anda *belum dapat kami terima* pada posisi yang dilamar saat ini.
...
Kami menghargai waktu dan usaha Anda, dan berharap dapat bertemu kembali di kesempatan lain.
Apabila ada pertanyaan, silakan membalas pesan ini.
...
HR Recruitment`;
                ...
                Swal.fire({
                    title: 'Buka WhatsApp?',
                    html: `
                        Kirim notifikasi <b>REJECTED</b> ke <b>${name || 'kandidat'}</b><br>
