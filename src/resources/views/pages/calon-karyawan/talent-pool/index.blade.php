...
@section('title', 'Calon Karyawan - Talent Pool')
                ...
                <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-2">
                    <div>
                        ...
                        <p class="text-muted mb-0">
                            ...
                            <span class="ms-2 badge bg-light-info text-dark">TALENT_POOL</span>
                        </p>
                    </div>
            ...
            <div class="card-body">
                @if($calonKaryawans->count() === 0)
                    <div class="alert alert-light-primary mb-0">
                        ...
                        Tidak ada calon karyawan (TALENT_POOL).
                    </div>
                @else
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a class="dropdown-item"
                                                       href="{{ route('admin.calon-karyawan.talent-pool.show', $ck->id) }}">
                                                ...
                                                <li>
                                                    <button type="button"
                                                        ...
                                                        <i class="bi bi-send-check me-2"></i> Lanjut Offering
                                                    </button>
                                                </li>
                                                ...
                                                <li>
                                                    <button type="button"
                                                            ...
                                                            data-url="{{ route('admin.calon-karyawan.talent-pool.destroy', $ck->id) }}"
                                                            data-name="{{ $ck->nama_lengkap }}"
                                                            data-nik="{{ $ck->nik }}">
