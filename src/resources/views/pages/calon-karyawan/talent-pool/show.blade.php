            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.calon-karyawan.talent-pool.index') }}" class="btn btn-light btn-sm">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start gap-3">
                            <div class="rounded-circle bg-light-info d-flex align-items-center justify-content-center"
                        ...
                        <div class="d-grid gap-2">
                            <button type="button"
                                ...
                                <i class="bi bi-send-check me-1"></i> Lanjut Offering
                            </button>

                            <button type="button"
                                    class="btn btn-light btn-sm btn-update-status"
                                    data-url="{{ route('admin.calon-karyawan.update-status-recruitment', $calonKaryawan->id) }}"
                                    data-name="{{ $calonKaryawan->nama_lengkap }}"
                                    data-status="TES_TULIS">
                                <i class="bi bi-arrow-counterclockwise me-1"></i> Kembalikan ke Tes Tulis
                            </button>

                            <button type="button"
                                    class="btn btn-warning btn-sm btn-update-status"
                                    data-url="{{ route('admin.calon-karyawan.update-status-recruitment', $calonKaryawan->id) }}"
                                    data-name="{{ $calonKaryawan->nama_lengkap }}"
                            ...
                            <button type="button"
                                    ...
                                    data-url="{{ route('admin.calon-karyawan.talent-pool.destroy', $calonKaryawan->id) }}"
                                    data-name="{{ $calonKaryawan->nama_lengkap }}"
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="fw-semibold">
                                    {{ $calonKaryawan->tanggal_lahir ? \Illuminate\Support\Carbon::parse($calonKaryawan->tanggal_lahir)->format('Y-m-d') : '-' }}
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="fw-semibold">
                                    {{ $calonKaryawan->tanggal_lahir_ayah ? \Illuminate\Support\Carbon::parse($calonKaryawan->tanggal_lahir_ayah)->format('Y-m-d') : '-' }}
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="fw-semibold">
                                    {{ $calonKaryawan->tanggal_lahir_ibu ? \Illuminate\Support\Carbon::parse($calonKaryawan->tanggal_lahir_ibu)->format('Y-m-d') : '-' }}
                                </div>
                            </div>
                        </div>
                    </div>
...
@push('scripts')
    <script>
        $(function () {
            const indexUrl = @json(route('admin.calon-karyawan.talent-pool.index'));
            ...
            $(document).on('click', '.btn-update-status', function () {
                ...
                const isRollback = status === 'TES_TULIS';
                const isOffering = status === 'OFFERING';

                let title = 'Ubah status?';
                if (isReject) title = 'Reject calon karyawan?';
                else if (isRollback) title = 'Kembalikan ke Tes Tulis?';
                else if (isOffering) title = 'Lanjutkan ke Offering?';
