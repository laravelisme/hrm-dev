            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.calon-karyawan.offering.index') }}" class="btn btn-light btn-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <button type="button"
                                ...
                                <i class="bi bi-arrow-counterclockwise me-1"></i> Kembalikan ke Talent Pool
                            </button>
                            ...
                            <button type="button"
                                    ...
                                    data-url="{{ route('admin.calon-karyawan.offering.destroy', $calonKaryawan->id) }}"
                                    data-name="{{ $calonKaryawan->nama_lengkap }}"
...
@push('scripts')
    <script>
        $(function () {
            const indexUrl = @json(route('admin.calon-karyawan.offering.index'));
            ...
            $(document).on('click', '.btn-update-status', function () {
                ...
                const isRollback = status === 'TALENT_POOL';

                let title = 'Ubah status?';
                if (isReject) title = 'Reject calon karyawan?';
                else if (isRollback) title = 'Kembalikan ke Talent Pool?';
