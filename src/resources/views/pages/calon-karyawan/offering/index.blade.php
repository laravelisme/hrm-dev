...
@section('title', 'Calon Karyawan - Offering')
                ...
                <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-2">
                    <div>
                        ...
                        <p class="text-muted mb-0">
                            ...
                            <span class="ms-2 badge bg-light-success text-dark">OFFERING</span>
                        </p>
                    </div>
            ...
            <div class="card-body">
                @if($calonKaryawans->count() === 0)
                    <div class="alert alert-light-primary mb-0">
                        ...
                        Tidak ada calon karyawan (OFFERING).
                    </div>
                @else
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a class="dropdown-item"
                                                       href="{{ route('admin.calon-karyawan.offering.show', $ck->id) }}">
                                                ...
                                                <li>
                                                    <button type="button"
                                                        ...
                                                        <i class="bi bi-arrow-counterclockwise me-2"></i> Kembalikan ke Talent Pool
                                                    </button>
                                                </li>
                                                ...
                                                <li>
                                                    <button type="button"
                                                            ...
                                                            data-url="{{ route('admin.calon-karyawan.offering.destroy', $ck->id) }}"
                                                            data-name="{{ $ck->nama_lengkap }}"
                                                            data-nik="{{ $ck->nik }}">
    ...
    <script>
        $(function () {
            ...
            $(document).on('click', '.btn-wa', function () {
                ...
                Selamat! Anda dinyatakan *LOLOS* ke tahap *OFFERING*.
                ...
                Kami akan segera menghubungi Anda lebih lanjut terkait proses offering.
                ...
                Swal.fire({
                    title: 'Buka WhatsApp?',
                    html: `
                        Kirim notifikasi <b>OFFERING</b> ke <b>${name || 'kandidat'}</b><br>
