...
@section('title', 'Calon Karyawan - Interview')
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-2">
                    <div>
                        <h4 class="mb-0">Interview</h4>
                        <p class="text-muted mb-0">
                            Total: <span class="fw-bold">{{ $calonKaryawans->total() }}</span> calon karyawan
                            <span class="ms-2 badge bg-light-primary text-dark">INTERVIEW</span>
                        </p>
                    </div>
            ...
            <div class="card-body">
                @if($calonKaryawans->count() === 0)
                    <div class="alert alert-light-primary mb-0">
                        ...
                        Tidak ada calon karyawan (INTERVIEW).
                    </div>
                @else
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a class="dropdown-item"
                                                       href="{{ route('admin.calon-karyawan.interview.show', $ck->id) }}">
                                                ...
                                                <li>
                                                    <a class="dropdown-item"
                                                       href="{{ route('admin.calon-karyawan.interview.show-link-zoom', $ck->id) }}">
                                                        <i class="bi bi-link-45deg me-2"></i> Show Zoom
                                                    </a>
                                                </li>
                                                ...
                                                <li>
                                                    <button type="button"
                                                        ...
                                                        <i class="bi bi-file-earmark-check me-2"></i> Lanjut ke Offering
                                                    </button>
                                                </li>

                                                {{-- Simpan sebagai TALENT_POOL --}}
                                                <li>
                                                    <button type="button"
                                                            class="dropdown-item text-info btn-update-status"
                                                            data-url="{{ route('admin.calon-karyawan.update-status-recruitment', $ck->id) }}"
                                                            data-name="{{ $ck->nama_lengkap }}"
                                                            data-status="TALENT_POOL">
                                                        <i class="bi bi-people me-2"></i> Simpan ke Talent Pool
                                                    </button>
                                                </li>
                                                ...
                                                <li>
                                                    <button type="button"
                                                        ...
                                                        <i class="bi bi-arrow-counterclockwise me-2"></i> Kembalikan ke Tes Tulis
                                                    </button>
                                                </li>
                                                ...
                                                <li>
                                                    <button type="button"
                                                            ...
                                                            data-url="{{ route('admin.calon-karyawan.interview.destroy', $ck->id) }}"
                                                            data-name="{{ $ck->nama_lengkap }}"
                                                            data-nik="{{ $ck->nik }}">
    ...
    <script>
        $(function () {
            ...
            $(document).on('click', '.btn-update-status', function () {
                ...
                if (status === 'OFFERING') {
                    title = 'Lanjutkan ke Offering?';
                    confirmText = 'Ya, Lanjutkan';
                } else if (status === 'TALENT_POOL') {
                    title = 'Simpan ke Talent Pool?';
                    confirmText = 'Ya, Simpan';
                } else if (status === 'TES_TULIS') {
                    title = 'Kembalikan ke Tes Tulis?';
                    confirmText = 'Ya, Kembalikan';
                } else if (isReject) {
                    title = 'Reject calon karyawan?';
